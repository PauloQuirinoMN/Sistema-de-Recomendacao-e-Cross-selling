...
def main():
    ...
    cod_produto = 23649  # 🔁 Altere aqui o produto para testar
    ...
    regras = cross.gerar_regras(cod_produto, min_support=0.01, min_threshold=1.0, max_len=2)
