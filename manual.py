    ...
    def __init__(self):
        ...
        self.content = ft.Column(
            [
                ...
                ft.Text("🔍 Como Pesquisar", size=22, weight="bold"),
                ft.Text(
                ...
                ft.Text("📊 Resultados", size=22, weight="bold"),
                ft.Text(
                    "Caso 1: Produto Encontrado → Exibe dados completos do item, lista de substitutos da mesma categoria e associados.\n"
                    "Caso 2: Categoria Encontrada → Mostra três produtos da mesma categoria.\n"
                    "Caso 3: Código Inválido → Mensagem informativa será exibida.",
                    text_align=ft.TextAlign.JUSTIFY,
                    size=18
                ),

                ft.Text("⚡ Funcionalidades", size=22, weight="bold"),
                ft.Text(
                ...
                ft.Text("💡 Dicas", size=22, weight="bold"),
                ft.Text(
